...
/** Renders assistant message bodies as GFM markdown (links, tables, code blocks). */
...
const defaultComponents = memoizeMarkdownComponents({
  h1: ({ className, ...props }) => (
    <h1
      className={cn(
        "aui-md-h1 mt-5 mb-3 scroll-m-20 font-semibold text-foreground text-xl tracking-tight first:mt-0 last:mb-0",
        className,
      )}
      {...props}
    />
  ...
  h2: ({ className, ...props }) => (
    <h2
      className={cn(
        "aui-md-h2 mt-5 mb-2 scroll-m-20 font-semibold text-foreground text-lg tracking-tight first:mt-0 last:mb-0",
        className,
      )}
      {...props}
    />
  ...
  h3: ({ className, ...props }) => (
    <h3
      className={cn(
        "aui-md-h3 mt-4 mb-2 scroll-m-20 font-semibold text-base text-foreground first:mt-0 last:mb-0",
        className,
      )}
      {...props}
    />
  ...
  p: ({ className, ...props }) => (
    <p
      className={cn(
        "aui-md-p my-3 text-[15px] text-foreground leading-relaxed first:mt-0 last:mb-0",
        className,
      )}
      {...props}
    />
  ...
  li: ({ className, ...props }) => (
    <li
      className={cn(
        "aui-md-li text-[15px] text-foreground leading-relaxed",
        className,
      )}
      {...props}
    />
